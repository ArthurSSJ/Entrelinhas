...
/**
 * Rodapé da home. O `Rodape` claro segue nas páginas de texto e no fluxo.
 */
export default function RodapeNoite() {
  return (
    <footer className="relative">
      <span className="linha-fina absolute inset-x-0 top-0 h-px" aria-hidden />

      <div className="shell-l grid gap-8 py-12 md:grid-cols-[minmax(0,1fr)_auto] md:items-start md:gap-16">
